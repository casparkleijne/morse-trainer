...
func _ready() -> void:
	...
	var button1 = %Card1/MarginContainer/PanelContainer/MarginContainer/PanelContainer/Button
	var button2 = %Card2/MarginContainer/PanelContainer/MarginContainer/PanelContainer/Button
	var button3 = %Card3/MarginContainer/PanelContainer/MarginContainer/PanelContainer/Button
	var button4 = %Card4/MarginContainer/PanelContainer/MarginContainer/PanelContainer/Button
	var button5 = %Card5/MarginContainer/PanelContainer/MarginContainer/PanelContainer/Button
...
func _on_button_pressed(letter: String):
	EventBus.letter_selected.emit(letter)
